...
<body>
    ...
    %>
            ...
            <nav>
                ...
                <br><br>
                <a href="http://localhost:8080/clientes/acessar/atualizar_cliente.jsp" target="centro">Atualizar Cliente</a>
                <a href="http://localhost:8080/vendedor/acessar/atualizar_vendedor.jsp" target="centro">Atualizar Vendedor</a>
