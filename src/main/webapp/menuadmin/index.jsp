...
<html lang="pt-BR">
    ...
    <body>
        ...
        <nav>
            ...
            <a href="http://localhost:8080/adicionar/cadastrarvendedor.jsp" target="centro">Cadastrar vendedor</a>
            ...
            <a href="http://localhost:8080/deletar/deletar_outros.jsp" target="centro">Deletar</a>
